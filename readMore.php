...
if ( $post_id ) {
    ...
    if ( $result && mysqli_num_rows( $result ) == 1 ) {
        ...
        $comsql    = "SELECT c.*,u.name FROM comments c JOIN users u ON c.post_id = $post_id AND c.user_id = u.id ORDER BY commentdate DESC";
...
<div class="content">
    ...
    <!--<a href="add_comment.php?id" class="commentslink"> Leave a comment: </a><br><br> -->
    ...
    <?php foreach ( $comments as $comm ): ?>  
        ...
        <?php if ( $comm[ 'post_id' ] == $post[ 'id' ] ): ?> 
            <div class="sidebar-box-com"> 
                ...
                <p><b>Written by: </b><i><?= htmlentities( $comm[ 'name' ] ); ?></i>, On: <?= $comm[ 'commentdate' ]; ?></p>
